			...
			<div class="article__container">
				...
				<div class="container__author">
					...
					<div class="author__info">
						...
						<p><b>Граф</b> — математическая абстракция реальной системы любой природы, объекты которой обладают парными связями. Граф как математический объект есть совокупность двух множеств — множества самих объектов, называемого множеством вершин, и множества их парных связей, называемого множеством рёбер. Элемент множества рёбер есть пара элементов множества вершин.
						<br></br>Графы находят широкое применение в современной науке и технике. Они используются и в естественных науках и в социальных науках, но наибольших масштабов применение графов получило в информатике и сетевых технологиях.
						<br></br><b>Фрагментом</b> называется связный подграф остовного дерева графа.</p>
					</div>
				</div>
				<div class="container__author">
					<div class="author__info">
				...
				<div class="container__author">
					...
					<div class="author__info">
						<h2><a href="/method-eul" style="color: #fff; text-decoration:underline;">Метод нахождения эйлерова цикла или пути в графе</a></h2>
