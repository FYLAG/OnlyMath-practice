			...
			<div class="article__container">
				...
				<form action="#" class="container__data" method="POST">
					<div class="data__input">
						<input class="count__matrix" placeholder="размерность матрицы" type="number" min="2" max="25" value="" name="" title="«начение должно быть не меньше 1 и не больше 25" required>
					...
					<script>
						...
						$("#matrix_JS").on('click', 'input', function() {
					 	...
					 	// ƒобавление нового элемента на страницу.
